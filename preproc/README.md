...
|---------------------|-------------|--------------|
| Clean raw data | `preprocess_data.py` | [Click me to see cleaning code](preprocess_data.py) |
| Create new features | `feature_engineering.py` | [Click me to see feature code](feature_engineering.py) |
| View feature stats | `feature_documentation.txt` | [Click me to see feature importance](feature_documentation.txt) |
| See original data | `marineflow_demurrage_synth.csv` | [Click me to see raw data](marineflow_demurrage_synth.csv) |
| Use training data | `marineflow_train.csv` | [Click me to see training data](marineflow_train.csv) |
| Use validation data | `marineflow_validation.csv` | [Click me to see validation data](marineflow_validation.csv) |
| Use test data | `marineflow_test.csv` | [Click me to see test data](marineflow_test.csv) |
| Load saved pipeline | `preprocessing_pipeline.pkl` | [Click me to download pipeline](preprocessing_pipeline.pkl) |
...
type .\preproc\feature_documentation.txt
```
Or [Click me to see feature stats online](feature_documentation.txt)
...
---
**Back to Main Project**: [Click me to go to main README](../README.md)